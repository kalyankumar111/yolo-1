                    ...
                    <nav class="main-menu multi-page-menu text-black" style="display: block;">
                        <ul>
                            ...
                            <li class="active"><a href="corporate-portfolio-3-column.html">Portfolio</a>
                                <ul class="sub-menu">
                                    <li class="active"><a href="corporate-portfolio-3-column.html">3 column masonry</a></li>
...
<div class="co-portfolio-section-1 section pt-130 pb-50">
    <div class="container">
        ...
        <div class="co-isotop-grid-1 isotop-grid isotop-grid-masonry row">
            ...
            <div class="co-isotop-item-1 isotop-item branding web col-lg-4 col-md-6 col-12 no-padding">
            ...
            <div class="co-isotop-item-1 isotop-item mobile-app photography col-lg-4 col-md-6 col-12 no-padding">
                <a href="corporate-portfolio-details.html">
            ...
            <div class="co-isotop-item-1 isotop-item illustration web col-lg-4 col-md-6 col-12 no-padding">
                <a href="corporate-portfolio-details.html">
            ...
            <div class="co-isotop-item-1 isotop-item photography branding col-lg-4 col-md-6 col-12 no-padding">
                <a href="corporate-portfolio-details.html">
            ...
            <div class="co-isotop-item-1 isotop-item illustration mobile-app col-lg-4 col-md-6 col-12 no-padding">
                <a href="corporate-portfolio-details.html">
