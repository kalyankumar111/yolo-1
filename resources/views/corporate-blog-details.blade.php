                ...
                <div class="float-right">
                    <nav class="main-menu multi-page-menu text-black" style="display: block;">
                        <ul>
                            ...
                            <li class="active"><a href="corporate-blog.html">Blog</a>
                                <ul class="sub-menu">
                                    <li><a href="corporate-blog.html">Blog</a></li>
                                    <li class="active"><a href="corporate-blog-details.html">Blog Details</a></li>
                                </ul>
                            </li>
            ...
            <div class="col-lg-8 col-12 mb-20">
                ...
                <div class="co-comment-wrapper fix">
                    ...
                    <div class="co-comment-form row">
                        ...
                        <form action="#">
                            <div class="row">
                                <div class="col-md-4 col-12 mb-25"><input type="text" placeholder="Name"></div>
                                <div class="col-md-4 col-12 mb-25"><input type="email" placeholder="Email"></div>
                                <div class="col-md-4 col-12 mb-25"><input type="text" placeholder="Website"></div>
                                <div class="col-12 mb-25"><textarea placeholder="Message"></textarea></div>
