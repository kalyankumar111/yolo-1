...
<body>
            ...
            <div class="row justify-content-between">
                <div class="col-auto">
                    ...
                    <div class="float-left">
                        <a href="creative.html" class="header-logo">
                            <img src="img/creative/bg/Logo-2.png" class="img-height" alt=""></a>
                    </div>
                </div>
                <!--Menu Toggle-->
                <div class="col-auto">
    ...
    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img class="res-height vh-100 w-100" src="img/creative/bg/hero.jpg" class="vh-100 w-100"
                    alt="First slide">
                        ...
                        <div class="row">
                            ...
                            <div id="scene" class="cr-hero-content  text-center col-xs-12">
                                <div data-depth="0.5">
                                    ...
                                    <p class="my-5"> <a href="#cr-about"
                                            class="btn btn-border-white btn-hover-cr" data-scroll>Let's Begin</a> </p>
                                    <p>&nbsp;</p>
                                </div>
                            </div>
            ...
            <div class="carousel-item ">
                <img class="res-height vh-100 w-100" src="img/creative/bg/hero-3.jpg" class="vh-100  w-100"
                    alt="First slide">
            ...
            <div class="carousel-item ">
                <img class="res-height vh-100 w-100" src="img/creative/bg/hero-1.jpg" class="vh-100  w-100"
                    alt="First slide">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item ">
                <img class="res-height vh-100 w-100" src="img/creative/bg/hero-2.jpg" class="vh-100  w-100"
                    alt="First slide">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item ">
                <img class="res-height vh-100 w-100" src="img/creative/bg/hero-4.jpg" class="vh-100  w-100"
                    alt="First slide">
                <div class="carousel-caption d-none d-md-block">
    ...
    <!--Creative About-->
    <div id="cr-about" class="cr-about-section section parallax-window pt-150 pb-110" data-parallax="scroll"
        data-speed="0.5" data-image-src="img/creative/bg/about.jpg">
        <div class="container">
            ...
            <div class="row flex-column flex-lg-row-reverse">
                ...
                <div class="col-lg-6 col-12 mb-40">
                    ...
                    <div class="cr-about-video">
                        ...
                        <a href="https://player.vimeo.com/video/607502514?h=76ab162e61" class="video-popup"><img
                                src="img/creative/icon/play.png" alt=""></a>
                    </div>
                ...
                <div class="col-lg-6 col-12 mb-40">
                    ...
                    <div class="cr-about-content">
                        <p>We provide a range of design options that help you make your products more appealing. Our
                            ...
                            art. From simple photoshoots to aerial photography and campaign shoot
                            , we can deliver stunning photos that make you stand out from your competitors.</p>
                        <p>&nbsp;</p>
    ...
    <div id="cr-portfolio" class="cr-portfolio-section section">
        <div class="container-fluid">
            <div class="row">
                ...
                <!--Single Portfolio-->
                <div class="cr-isotop-item col-xl-3 col-lg-4 col-md-6 col-12">
                    <img src="img/creative/portfolio/tiger.jpg" class="object-responsive w-100 h-100" alt="" style="transform: scale(2.5);
                    object-position: -30px 40px;object-fit:cover">
                    <a href="img/creative/portfolio/tiger.jpg" class="cr-portfolio-content gallery-popup">
                        <span class="shape"></span>
                        <span class="shape"></span>
                ...
                <div class="cr-isotop-item col-xl-3 col-lg-4 col-md-6 col-12">
                    <img src="img/creative/portfolio/pic.jpeg" alt="">
                ...
                <!--Single Portfolio-->
                <div class="cr-isotop-item col-xl-3 col-lg-4 col-md-6 col-12">
                    <img src="img/creative/portfolio/big3.jpg" alt="">
                ...
                <!--Single Portfolio-->
                <div class="cr-isotop-item col-xl-3 col-lg-4 col-md-6 col-12">
                    <img src="img/creative/portfolio/idly.jpg" alt="">
    ...
    <!--Creative Service-->
    <div id="cr-service" class="cr-service-section section parallax-window pt-150 pb-50 " data-parallax="scroll"
        data-speed="0.5" data-image-src="img/creative/bg/service.jpg">
        <div class="container">
    ...
    <div id="cr-testimonial" class="cr-testimonial-section section parallax-window pt-150 pb-150"
        data-parallax="scroll" data-speed="0.5" data-image-src="img/creative/bg/testimonial.jpg">
        <div class="container">
    ...
    <!--Creative Footer-->
    <div id="cr-contact" class="cr-footer-section section parallax-window" data-parallax="scroll" data-speed="0.5"
        data-image-src="img/creative/bg/footer.jpg">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 mt-50">
                        ...
                        <div class="cr-footer-social text-center">
                            ...
                            <a href=" https://www.facebook.com/YoloStudioOfficial/"><i
                                    class="fa-brands fa-facebook-f text-white fa-lg"></i></a>
                            <a href="https://www.instagram.com/yolostudioofficial/"><i
                                    class="fa-solid fa-hashtag text-white fa-lg"></i></a>
                            <a href="https://www.flickr.com/people/studioyolo/">
                                <i class="fa-brands fa-flickr text-white fa-lg"></i></a>
                            <a href="https://vimeo.com/user145581541"><i
                                    class="fa-brands fa-vimeo text-white fa-lg"></i></a>
