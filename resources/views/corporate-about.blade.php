                ...
                <div class="float-right">
                    <nav class="main-menu multi-page-menu text-black" style="display: block;">
                        <ul>
                            ...
                            <li class="active"><a href="corporate-about.html">About</a></li>
...
<div class="co-page-banner-section section" data-page-title="about us" style="background-image: url(img/page-banner-bg.jpg)">
